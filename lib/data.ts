...
export const teamMembers = [
  ...
  },
  {
    ...
    image: "/default-avatar.png",
    bio: "Kisakye Martha is a detail-oriented quality assurance specialist. She coordinated testing phases, validated system performance, and compiled comprehensive project documentation.",
    email: "martha.kisakye@example.com",
    github: "https://github.com/marthakisakye",
    linkedin: "https://linkedin.com/in/marthakisakye",
    contributions: [
      "Coordinated testing phases and validation procedures",
      "Developed test cases and scenarios for system verification",
      "Compiled comprehensive project documentation",
